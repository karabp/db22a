...
lorem_words = str.split('acme lorem ipsum dolores si amet rex regina amo rosa dominus spiro spero dum minerva brutus mateo roma galileus file marcus julius tu che maraci lavo lavare amare erga burda luda rota mamale nomine agrum frulus macacus lota et', ' ')
...
def generate_project_participations_in_fields(project_ids, field_ids):
    ...
    for project in project_ids:
        for f in range(random.randint(*project_participation_in_fields_limits)):
            field = field_ids[f]
